...
/***/ function(module, exports, __webpack_require__) {
	...
	Array.from(document.querySelectorAll('.chart-placeholder')).forEach(function (placeholder) {
	    React.render(React.createElement(_Chart2.default, {
	        ...
	        availableTimeframes: placeholder.getAttribute('data-timeframes') || '' }), placeholder);
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _TimeframeAndInterval = __webpack_require__(198);

	var _TimeframeAndInterval2 = _interopRequireDefault(_TimeframeAndInterval);
	...
	_chart2.default.defaults.global.maintainAspectRatio = false;
	...
	var ChartComponent = (function (_React$Component) {
	    ...
	    function ChartComponent(props) {
	        ...
	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(ChartComponent).call(this, props));
	    ...
	    _createClass(ChartComponent, [{
	        ...
	        key: 'granularityChanged',
	        value: function granularityChanged(newGranularity) {
	            if (this.state.xhr) {
	                this.state.xhr.abort();
	            }
	            this.cleanSurface();
	        ...
	        key: 'timeframeChanged',
	        value: function timeframeChanged(newTimeframe) {
	            if (this.state.xhr) {
	                this.state.xhr.abort();
	            }
	            this.cleanSurface();
	        ...
	        key: 'getGranularities',
	        value: function getGranularities(newTimeframe) {
	            var output = {};
	        ...
	        value: function render() {
	            return React.createElement(
	                'div',
	                { style: { style: { 'box-sizing': 'content-box' } } },
	                this.renderTitle(),
	                this.renderLegend(),
	                this.renderLabels(),
	                ...
	                React.createElement(
	                    ...
	                    React.createElement(_TimeframeAndInterval2.default, {
	        ...
	        value: function renderTitle() {
	            ...
	            return React.createElement(
	                'strong',
	                { className: 'chart-title', title: this.props.title },
	                this.props.title
	            );
	        }
	    }, {
	        ...
	        value: function renderLabels() {
	            ...
	            return React.createElement(_Labels2.default, {
	        ...
	        value: function renderLegend() {
	            if (!this.state.legend) return null;
	            return React.createElement('div', { dangerouslySetInnerHTML: { __html: this.state.legend } });
	        }
	    }, {
	        key: 'startLoadingData',
	        value: function startLoadingData() {
	            var _this2 = this;
	            ...
	            req.onload = function () {
	                ...
	                _this2.setState({ data: parsed, xhr: null });

	                var canvas = _this2.cleanSurface();

	                var ctx = canvas.getContext('2d');
	                var c = new _chart2.default(ctx)[chartTypes[_this2.props.chartType]](_this2.state.data);
	                c.reflow();
	                if (_this2.props.hasLegend) {
	                    _this2.setState({ legend: c.generateLegend() });
	                }
	            };
	            req.open('get', '/analytics/' + this.props.type + '?podcast=' + encodeURIComponent(this.props.podcast) + (this.props.episode ? '&episode=' + encodeURIComponent(this.props.episode) : '') + (this.props.extra ? '&' + this.props.extra : '') + '&interval=' + this.state.granularity + '&timeframe=' + this.state.timeframe, true);
	            req.send();
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function(){
		...
		var each = helpers.each = function(loopable,callback,self){
			...
			amd = helpers.amd = ("function" == 'function' && __webpack_require__(194)),
			//-- Math methods
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _labella = __webpack_require__(197);
	...
	var Labels = (function (_React$Component) {
	    ...
	    function Labels(props) {
	        ...
	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Labels).call(this, props));
	    ...
	    _createClass(Labels, [{
	        key: 'componentDidMount',
	        value: function componentDidMount() {
	            setTimeout(this.startLoadingData.bind(this), Math.random() * 250);
	        }
	    }, {
	        key: 'componentWillUnmount',
	        value: function componentWillUnmount() {
	        ...
	        value: function componentWillReceiveProps(newProps) {
	            if (this.props.timeframe !== newProps.timeframe) {
	                if (newProps.timeframe) {
	                    setTimeout(this.startLoadingData.bind(this), 0);
	                }
	                this.reset();
	            }
	        ...
	        value: function reset() {
	            ...
	            this.setState({ xhr: null, data: null });
	        ...
	        value: function startLoadingData() {
	            ...
	            var url = '/dashboard/services/get_episodes?';
	            if (this.props.podcast) {
	                url += 'podcast=' + encodeURIComponent(this.props.podcast) + '&';
	            }
	            if (this.props.extra) {
	                url += this.props.extra + '&';
	            }

	            var startDate = this.getStartDate();
	            url += 'start_date=' + startDate.toISOString().replace(/\.\d+Z$/, ''); // Fuck off, milliseconds
	        ...
	        value: function getStartDate() {
	            ...
	            startDate.setDate(startDate.getDate() - durations[this.props.timeframe]);
	            return startDate;
	        }
	    }, {
	        key: 'renderLabels',
	        value: function renderLabels() {
	            ...
	            var surface = this.refs.surface.getDOMNode();
	            var innerWidth = surface.clientWidth;

	            var vis = d3.select(surface).append('svg').attr('width', innerWidth).attr('height', 100).append('g').attr('transform', 'translate(0, 100)');
	            var linkLayer = vis.append('g');
	            var labelLayer = vis.append('g');

	            var dummyText = vis.append('text');

	            var timeScale = function timeScale(date) {
	                var ticks = date.getTime();
	                var ratio = (ticks - startDateTicks) / (nowTicks - startDateTicks);
	                return ratio * (innerWidth - 5 - 40) + 40;
	            };

	            var nodes = data.map(function (ep) {
	                var bbox = dummyText.text(ep.title)[0][0].getBBox();
	                ep.h = bbox.height;
	                ep.w = bbox.width;
	                return new _labella.Node(timeScale(ep.parsedDate), ep.w + 9, ep);
	            });

	            dummyText.remove();

	            var renderer = new _labella.Renderer({
	                layerGap: 50,
	                nodeHeight: nodes[0].data.h,
	                direction: 'up'
	            });
	            var force = new _labella.Force({ minPos: 20, maxPos: innerWidth - 20 }).nodes(nodes).on('end', function () {
	                return draw(force.nodes());
	            }).start(100);
	            ...
	            function draw(nodes) {
	                ...
	                var sEnter = labelLayer.selectAll('rect.flag').data(nodes).enter().append('g').attr('transform', function (d) {
	                    return 'translate(' + (d.x - d.width / 2) + ', ' + d.y + ')';
	                });

	                sEnter.append('rect').classed('flag', true).attr('width', function (d) {
	                    return d.data.w + 9;
	                }).attr('height', function (d) {
	                    return d.data.h + 4;
	                }).attr('rx', 2).attr('ry', 2).style('fill', function () {
	                    return 'rgba(240, 240, 240, 0.5)';
	                });

	                sEnter.append('text').attr('x', 4).attr('y', 15).style('fill', '#000').text(function (d) {
	                    return d.data.title;
	                });

	                // Draw path from point on the timeline to the label rectangle
	                linkLayer.selectAll('path.link').data(nodes).enter().append('path').classed('link', true).attr('d', function (d) {
	                    return renderer.generatePath(d);
	                }).style('stroke', '#303F9F').style('stroke-width', 2).style('opacity', 0.6).style('fill', 'none');
	            }
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ChartOptionSelector = __webpack_require__(199);

	var _ChartOptionSelector2 = _interopRequireDefault(_ChartOptionSelector);
	...
	var TimeframeAndInterval = (function (_React$Component) {
	    _inherits(TimeframeAndInterval, _React$Component);

	    function TimeframeAndInterval() {
	        _classCallCheck(this, TimeframeAndInterval);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(TimeframeAndInterval).apply(this, arguments));
	    }

	    _createClass(TimeframeAndInterval, [{
	        key: 'render',
	        value: function render() {
	            return React.createElement(
	                'div',
	        ...
	        key: 'renderGranularity',
	        value: function renderGranularity() {
	            if (this.props.hideGranularity || this.props.chartType !== 'line') {
	                return null;
	            }
	            return React.createElement(_ChartOptionSelector2.default, {
	    ...
	    return TimeframeAndInterval;
	})(React.Component);

	exports.default = TimeframeAndInterval;
	;
...
/***/ function(module, exports) {
	...
	var ChartOption = (function (_React$Component) {
	    _inherits(ChartOption, _React$Component);

	    function ChartOption() {
	        _classCallCheck(this, ChartOption);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(ChartOption).apply(this, arguments));
	    }

	    _createClass(ChartOption, [{
	        key: 'render',
	        value: function render() {
	            return React.createElement(
	                'a',
	...
	var ChartOptionSelector = (function (_React$Component2) {
	    _inherits(ChartOptionSelector, _React$Component2);

	    function ChartOptionSelector() {
	        _classCallCheck(this, ChartOptionSelector);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(ChartOptionSelector).apply(this, arguments));
	    }

	    _createClass(ChartOptionSelector, [{
	        key: 'render',
	        value: function render() {
	            return React.createElement(
	                'div',
	        ...
	        value: function renderOptions() {
	            ...
	            return keys.map(function (option) {
	                return React.createElement(ChartOption, { value: option,
	                    ...
	                    setSelected: _this3.setSelected.bind(_this3) });
	            });
	        }
	    }, {
	        key: 'setSelected',
	...
	exports.default = ChartOptionSelector;
	;

...
FEATURE_MIN_GEOANALYTICS = PLAN_PRO
FEATURE_MIN_GEOANALYTICS_EP = PLAN_ULTIMATE
...
PLANS_RAW = {
    ...
    'FEATURE_MIN_GEOANALYTICS': FEATURE_MIN_GEOANALYTICS,
    'FEATURE_MIN_GEOANALYTICS_EP': FEATURE_MIN_GEOANALYTICS_EP,
